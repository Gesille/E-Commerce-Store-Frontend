...
import { activateUser, deleteUser, getAllUsers, getMostActiveUsers, getRecentUsers, getRegistrationsPerMonth, getTopSpenders, getUserActivity, getUserInfo, loginUser, logoutUser, registrationUser, socialAuth, updateAccessToken, updatePassword, updateProfilePicture, updateUserInfo, updateUserRole } from '../controllers/user.controller.js';
